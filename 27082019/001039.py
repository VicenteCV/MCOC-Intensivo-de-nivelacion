...
#Ejemplo 4
print 'Ejemplo 4'
l=np.random.randint(100,size=25)
print l
print 'Promedio: ',np.mean(l) #Promedio del array
print 'Maximo: ',np.max(l) #Valor maximo del array
print 'Varianza: ',np.var(l) #Varianza del array
print l<50 #Arroja si los valores son menores o no a 50
print l[l>50] #Array con los valores que son mayores a 50
